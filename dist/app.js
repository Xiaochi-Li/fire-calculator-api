...
var financialProfile_entity_1 = require("./entity/financialProfile/financialProfile.entity");
...
app.get("/financial-profile/health-check", function (req, res) {
...
app.get("financial-profile/:id", function (req, res) {
    // here we will have logic to return financial profile by id
});
app.post("/financial-profile", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var financialProfile, results;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, app_data_source_1.myDataSource
                        .getRepository(financialProfile_entity_1.FinancialProfile)
                        .create(req.body)];
                case 1:
                    financialProfile = _a.sent();
...
app.put("financial-profile/:id", function (req, res) {
    // here we will have logic to update a financial profile by a given financial profile id
});
app.delete("financial-profile/:id", function (req, res) {
